...
#    st.subheader('<div style="text-align:center;"> :black[**_National Informatics Centre_**]</div>', unsafe_allow_html=True)
   ...
   image1 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/nic.png')
   image2 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/emblem.png')
...
def about_gepnic():
    ...
    # Load the image using the Image class from PIL
     image1 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/gepnic.jpg')
     image2 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/gep1.png')
     # Define the desired size of the images
     image_size = (900, 500)
...
def dataset():
    ...
    image1 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/training_img.jpg')
    image2 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/testing_img.jpg')
    image3 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/testing_img.jpg')
     # Define the desired size of the images
    image_size = (600, 600)
    ...
    image1 = image1.resize(image_size)
    image2 = image2.resize(image_size)
    image3 = image3.resize(image_size)
...
""", unsafe_allow_html=True)
    ...
    auction = pd.read_csv('C:/Users/maadh/OneDrive/Documents/New Auction/training_dataset.csv')
    auction2 = pd.read_csv('C:/Users/maadh/OneDrive/Documents/New Auction/testing_dataset.csv')
    auction3 = pd.read_csv('C:/Users/maadh/OneDrive/Documents/New Auction/validation_data.csv')
...
def recommend_auctions():
    df1 = pd.read_csv('C:/Users/maadh/OneDrive/Documents/New Auction/training_dataset.csv')
    df2 = pd.read_csv('C:/Users/maadh/OneDrive/Documents/New Auction/testing_dataset.csv')
    # Data Visualisation
    ...
    st.sidebar.title("Statistical Information :blue[**_Plots_**]")
    ...
    if selected_option == 'Content based Filtering':
        st.markdown("<span title='This option uses content-based filtering algorithm'>ℹ️ Content based Filtering</span>", unsafe_allow_html=True)
    ...
    # Display the details and append an "Apply" button for each segment of data
            for detail in details:
                ...
                with col2:
                    if detail['tender_type_name']=='Open Tender':
                        image1 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/ot.png')
                        st.image(image1, use_column_width=True)
                    elif detail['tender_type_name']=='Limited':
                        image2 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/limited1.jpg')
                        st.image(image2, use_column_width=True)
                    elif detail['tender_type_name']=='Open Limited':
                        image3 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/open_lim.png')
                        st.image(image3, use_column_width=True)
                    elif detail['tender_type_name']=='Global Tenders':
                        image4 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/gt2.jpg')
                        st.image(image4, use_column_width=True)
                    elif detail['tender_type_name']=='EOI':
                        image5 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/eoi2.jpg')
                        st.image(image5, use_column_width=True)
                    elif detail['tender_type_name']=='Test':
                        image6 = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/test2.png')
        ...
        st.markdown("<span title='This option uses collaborative-based filtering algorithm'>ℹ️</span> Collaborative Filtering", unsafe_allow_html=True)
    ...
    # Display the details and append an "Apply" button for each segment of data
            for detail in details:
                ...
                #         st.success(f"Application submitted successfully.")
                st.markdown("<hr>", unsafe_allow_html=True)  
    elif selected_option == 'Hybrid Based Filtering': 

        st.markdown("<span title='This option uses Hybrid filtering algorithm'>ℹ️ Hybrid Filtering</span>", unsafe_allow_html=True)
        if recommend_button_clicked:
        # Create a dataframe of the top 10 most similar rows from Dataset 2
    ...
    st.sidebar.title(" Real Time :blue[**_Plot Variations_**]")
...
def berth():
    ...
    # Get the indices of the top 10 most similar rows using content-based filtering
    content_based_indices = cosine_similarities.argsort()[:-11:-1]
    content_top_10 = df.iloc[content_based_indices, [0, 2, 3, 4, -3, -1]].loc[df2['active'] == 1]
    ...
    collab_top_10 = df.iloc[collaborative_indices, [0, 1, 5, 2, 3, 4, -3, -1]].loc[df2['active'] == 1]
    ...
    if recommend_button_clicked:
    # Create a dataframe of the top 10 most similar rows from Dataset 2
        top_10 =df2.iloc[hybrid_indices, [0, 2, 3, 4, 5,-1,9,8]].loc[df2['active'] == 1]
...
def contact():
    ...
    st.write('<div style="text-align:left;"><h3>Contact Information</h3></div>', unsafe_allow_html=True)
...
def feedback():
    ...
    filename = os.path.join(os.path.expanduser("~"), "OneDrive", "Documents", "New Auction", "feedback.xlsx")
    with st.form(key='feedback_form'):
        ...
        if submitted:
            ...
            if os.path.isfile(filename):
                # Read the existing feedback data into a DataFrame
                ...
                # If the feedback file does not exist, create a new DataFrame with the new feedback data
                feedback_df = pd.DataFrame([feedback_data])
            
            # Save the feedback DataFrame into the Excel file, overwriting the previous data
...
def main():
    ...
    options = ["HOME","ABOUT GEPNIC","ABOUT PROJECT","DATASET","RECOMMEND AUCTION USING (TF-IDF)","RECOMMEND AUCTION USING(BERTH)","CONTACT","FEEDBACK"]
    ...
    if selected_option == "HOME":
        ...
        recommend_auctions()
    elif selected_option == "RECOMMEND AUCTION USING(BERTH)":
        berth()
