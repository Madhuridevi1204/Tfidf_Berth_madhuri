...
def home():
   ...
   image = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/nic.png')
   ...
   image_path = "/path/to/your/image.png"
   # Load the image using the Image class from PIL
   image = Image.open('C:/Users/maadh/OneDrive/Documents/New Auction/gepnic.jpg')
   # Display the image using st.image
   st.image(image, use_column_width=True)
...
def dataset():
    st.markdown("<h4 style='text-align: center;'>ABOUT THE DATASET</h4>", unsafe_allow_html=True)
...
""", unsafe_allow_html=True)
    ...
    auction = pd.read_csv('C:/Users/maadh/OneDrive/Documents/New Auction/2023_GePNIC dataset1.csv')
    st.write(auction)
...
def recommend_auctions():
    ...
    top_n_filter = top_n_auctions[top_n_auctions['tender_id'].str.startswith('2023')]
    ...
    if 'Distribution of Auction Categories' in plot_options:
        ...
        st.pyplot(fig9)
def berth():
    df = pd.read_csv('C:/Users/maadh/OneDrive/Documents/New Auction/2023_GePNIC dataset1.csv')
    df.head()
...
def contact():
    st.markdown("<h4 style='text-align: justify;'>R.MADHURI DEVI</h4>", unsafe_allow_html=True)
...
def feedback():
    st.markdown("<h4 style='text-align: center;'>WEBSITE FEEDBACK FORM </h4>", unsafe_allow_html=True)
